...
Converts content into authentic, vertically-optimized Xiaohongshu (RedNote) style notes. Use when asked to write a Xiaohongshu post or note.
...
```bash
gemini skills install ./xiaohongshu-note-generator-skill
```
